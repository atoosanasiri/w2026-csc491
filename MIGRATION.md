...
- Mermaid support: first-class support for [Mermaid](https://mermaid.js.org/) - a JavaScript-based diagram and charting tool supported by GitHub - has been added to the theme. **This feature is opt-in.** See the new doc subsections in [Configuration](docs/configuration.md#mermaid-diagrams) and [Code](docs/ui-components/code/index.md#mermaid-diagram-code-blocks) for more.
...
In addition to customizing the search placeholder, we've also added the ability to provide custom content to the search index. for more, see [Custom content for search index](docs/search.md#custom-content-for-search-index). PR: [#1068].
...
- Links wrap. PR: [#905]
- Callouts: a new component similar to alerts or banners. See [UI Components - Callouts](docs/ui-components/callouts.md). PR: [#466]
